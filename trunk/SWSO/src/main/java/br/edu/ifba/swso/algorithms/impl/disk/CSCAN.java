 ...
 *
 */
public class CSCAN extends DiskScheduler implements IDiskScheduler {

	private final String nome = "C-SCAN";
	
	public CSCAN(VirtualMachineParameters virtualMachineParameters) {
