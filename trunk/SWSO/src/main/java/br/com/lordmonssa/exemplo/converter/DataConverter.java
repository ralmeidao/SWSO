...
import br.com.lordmonssa.exemplo.arquitetura.util.Constantes;
...
public class DataConverter extends DateTimeConverter {
	...
	/**
	 * Metodo preenche o map dataInvalida com o id do componente e booleano que informa
	 * se a data informada pelo usuario e invalida 
	 * 
	 * @param component
	 * @param dataInvalida
	 * @param pIsDataValida 
