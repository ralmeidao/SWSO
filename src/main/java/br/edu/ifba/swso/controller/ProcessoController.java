...
import br.edu.ifba.swso.algorithms.impl.process.ShortestJobFirst;
import br.edu.ifba.swso.algorithms.impl.process.ShortestJobFirstPreemptive;
...
public class ProcessoController extends BaseController implements Serializable {
	...
	public void init() {
		...
		this.arrayProcessesScheduler = new IProcessesScheduler[]{new FIFO(), new RoundRobin(), new Prioridade(), new ShortestJobFirst(), new ShortestJobFirstPreemptive()};
