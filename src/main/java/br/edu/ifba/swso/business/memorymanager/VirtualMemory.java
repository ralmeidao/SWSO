...
import br.edu.ifba.swso.business.memorymanager.exception.VirtualMemoryFullException;
...
public class VirtualMemory {
	...
	public void liberaPosicao(int pos) throws VirtualMemoryFullException {
			virtualMemory[pos] = '0';
	}
