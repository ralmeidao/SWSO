...
/**
 * Classe para convercao de campos tipo data.
 * 
 * @author esouzaa
 *
 */
...
public class CpfValidator implements Validator {
	...
	/**
	 * Valida CPF do usuario. Não aceita cpfs padrão, como 11111111111 ou
	 * 22222222222
	 * 
	 * @param cpf
	...
	public boolean isCpfValido(Object arg2) {
		
		String cpf = arg2.toString();
		
		arg2 = Util.lpad(cpf, '0', 11);
